...
| l_no    | m_no    | l_title  | l_con    | l_date | l_name   | l_address | l_koo   |
| ------- | ------- | -------- | -------- | ------ | -------- |---------- |---------|
| 자체seq | 회원seq | 제목     | 내용     | 시간     | 기관명   | 기관주소   | 기관 구  |
| number  | number  | varchar2 | varchar2 | date   | varchar2 | varchar2  | varchar2 |
| primary | NN      | NN       |          | NN     | NN       | NN        | NN       |
