				...
				<div class="row gap">
					...
					<div class="col-md-12">
						<table class="table table-striped" style="">
							<tr>
								<td colspan="2">제목: <input type=text id=b_title
							...
							<tr>
								<td colspan="2" rows=10 cols=90
									style="border: none; background-color: transparent; resize: none;">
										...
										<p style="font-size:20px;">${b_con }</p>
										</div>
								</td>
							</tr>
							<tr>
						...
						<br> <input type=button value='목록으로 돌아가기' id=btnReset
							class="btn btn-primary btn-outlined"> <input type=hidden
							id="m_no" name="m_no" > <input type=hidden
							id="btdo.m_no" name="bdto.m_no">
					...
					success : function(data) {
						...
						for (let i = 0; i < data.length; i++) {
							...
							if (i == doo) {
								$('#re_replylist' + num)
										.append(
												'<input type="button" id="btndoo" seqnum="'+num+'" value="더보기">');
								break;
							}
						}
						;
