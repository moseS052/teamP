		...
		<div class="container">
			...
			<div class="row mt">
				<div class="centered gap fade-down section-heading">
					...
					<p>후기 사진을 올려주세요</p>
					<div >
						<input class="btn btn-outlined btn-primary pull-right" type="button" value="후기올리기">
					</div>
				</div>
			</div>
			...
			<div class="row mt gap">
				<div class="col-md-4 post fade-up">
					<div class="item-inner">
						<img style="width:400px; height:245px;" src=<c:url value="/resources/assets/userimg/donation_01.jpg"/> alt=""
					...
					<p>
						<a class="btn btn-outlined btn-primary" href="#">Read
							More</a>
					</p>
				</div>
				<div class="col-md-4 post fade-up">
					<div class="item-inner">
						<img style="width:400px; height:245px;" src=<c:url value="/resources/assets/userimg/handshake.jpg"/> alt=""
							class="img-responsive">
						<div class="overlay">
							<a class="preview btn btn-outlined btn-primary"
				...
				<div class="col-md-4 post fade-up">
					<div class="item-inner">
						<img src=<c:url value="/resources/assets/img/demo/12.jpg"/> alt=""
							class="img-responsive">
						<div class="overlay">
							<a class="preview btn btn-outlined btn-primary"
								href="single-post.html"><i class="fa fa-link"></i></a>
